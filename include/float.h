...
#define DECIMAL_DIG 21 // 浮点类型转换为21位十进制数，而值不变
...
#define LDBL_DIG 15          // long double有效数字位数
#define LDBL_EPSILON 0x1p-52 // 1.0和long double的最小差值
#define LDBL_MANT_DIG 53 // 能无精度损失地表示成long double的2进制最大位数
#define LDBL_MAX 0x1.fffffffffffffp+1023 // long double最大值
#define LDBL_MAX_10_EXP 308  // long double的10进制指数的最大值
#define LDBL_MAX_EXP 1024    // long double的2进制指数的最大值
#define LDBL_MIN 0x1p-1022   // long double的最小值
#define LDBL_MIN_10_EXP -307 // long double的10进制指数的最大值
#define LDBL_MIN_EXP -1021   // long double的2进制指数的最小值
#define LDBL_TRUE_MIN 0x0.0000000000001p-1022 // long double的最小正值
